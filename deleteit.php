...
if(isset($_GET['search'])){
    ...
    $sql = "SELECT User_bloodinfo.*, receivers.* from User_bloodinfo, receivers where User_bloodinfo.rid=receivers.id && bg='$searchKey'";
}else{
    $sql = "SELECT User_bloodinfo.*, receivers.* from User_bloodinfo, receivers where User_bloodinfo.rid=receivers.id";
}
