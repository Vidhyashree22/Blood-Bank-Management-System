...
if(isset($_GET['search'])){
    ...
    $sql = "select hospital_bloodinfo.*, hospitals.* from hospital_bloodinfo, hospitals where hospital_bloodinfo.hid=hospitals.id && bg='$searchKey'";
}else{
    $sql = "select hospital_bloodinfo.*, hospitals.* from hospital_bloodinfo, hospitals where hospital_bloodinfo.hid=hospitals.id";
}
