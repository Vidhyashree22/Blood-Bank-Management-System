...
-- --------------------------------------------------------
--
-- Table structure for table `User_bloodinfo`
--


CREATE TABLE `User_bloodinfo` (
...
INSERT INTO `User_bloodinfo` (`bdid`, `rid`, `bg`) VALUES
(10, 1, 'A+'),
(11, 1, 'B-'),
(12, 4, 'B+'),
(13, 4, 'O+'),
...
--
-- Table structure for table `hospital_bloodinfo`
--

CREATE TABLE `hospital_bloodinfo` (
  `bid` int(11) NOT NULL,
  `hid` int(11) NOT NULL,
  `bg` varchar(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Dumping data for table `hospital_bloodinfo`
--

INSERT INTO `hospital_bloodinfo` (`bid`, `hid`, `bg`) VALUES
(7, 1, 'A-'),
(8, 1, 'O+'),
(12, 4, 'A-'),
(13, 4, 'A+'),
...
--
ALTER TABLE `User_bloodinfo`
  ADD PRIMARY KEY (`bdid`),
  ADD KEY `User_bloodinfo_ibfk_2` (`rid`);
...
--
ALTER TABLE `hospital_bloodinfo`
  ADD PRIMARY KEY (`bid`),
  ADD KEY `hid` (`hid`);
...
--
-- Constraints for table `user_blooddinfo`
--
ALTER TABLE `User_bloodinfo`
  ADD CONSTRAINT `User_bloodinfo_ibfk_2` FOREIGN KEY (`rid`) REFERENCES `receivers` (`id`);

--
-- Constraints for table `hopital_bloodinfo`
--
ALTER TABLE `hospital_bloodinfo`
ADD CONSTRAINT `hospital_bloodinfo_ibfk_1` FOREIGN KEY (`hid`) REFERENCES `hospitals` (`id`);
COMMIT;
